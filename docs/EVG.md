...
Effective as of 1 October 2020, the CA SHALL ensure that the information to be included is consistent with its publicly-available disclosure, as described in Section 8.2.2.
...
Effective as of 1 October 2020, the CA SHALL ensure that the format of any Registration Number that is included is consistent with the publicly-available disclosure for that Registration Agency or Incorporating Agency, as described in Section 8.2.2.
